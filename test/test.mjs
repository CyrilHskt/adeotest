...
import { filterAnimals, countPeopleAndAnimals } from '../src/utils/utils.js'

describe('Filter Animals', function() {
  it('should return the list of countries and people owning animals that match the given pattern', function() {
  ...
  it('should return an empty list if no countries match the given animal pattern', function() {
    const result = filterAnimals('Toto');
    assert.deepStrictEqual(result, []);
  });
});

describe('Count People and Animals', function() {
  it('should return data with a counter in the main title counting the members of the categories (Country Population, Animals)', function() {
    const result = countPeopleAndAnimals();
    assert.deepStrictEqual(result, [
        {
          "name": "Dillauti [5]",
          "people": [
